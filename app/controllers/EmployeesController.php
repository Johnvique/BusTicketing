...
class EmployeesController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		$db = $this->GetModel();
		$fields = array('id', 	'photo', 	'name', 	'contact', 	'address', 	'email', 	'roles');
		...
		if(!empty($this->search)){
			...
			$db->orWhere('contact',"%$text%",'LIKE');
			$db->orWhere('address',"%$text%",'LIKE');
			$db->orWhere('email',"%$text%",'LIKE');
			$db->orWhere('roles',"%$text%",'LIKE');
		}
		...
		$this->view->page_title ="Employees";
	...
	function view( $rec_id = null , $value = null){
		...
		$record = $db->getOne( 'employees', $fields );
		if(!empty($record)){
			$this->view->page_title ="View  Employees";
	...
	function add(){
		...
		$this->view->page_title ="Add New Employees";
	...
	function edit($rec_id=null){
		...
		$fields = array('id','photo','name','contact','address','roles');
		$db->where('id' , $rec_id);
		$data = $db->getOne('employees',$fields);
		$this->view->page_title ="Edit  Employees";
		if(!empty($data)){
