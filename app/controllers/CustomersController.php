...
class CustomersController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		$db = $this->GetModel();
		$fields = array('id', 	'name', 	'phone', 	'email', 	'role');
		...
		$this->view->page_title ="Customers";
	...
	function view( $rec_id = null , $value = null){
		...
		if(!empty($record)){
			$this->view->page_title ="View  Customers";
	...
	function edit($rec_id=null){
		...
		$this->view->page_title ="Edit  Customers";
		if(!empty($data)){
