        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">View  Buses</h3>
                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        <div class="p-3">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("buses/edit/$data[id]"); ?>">
                            ...
                            <a class="btn btn-sm btn-danger recordDeletePromptAction"  href="<?php print_link("buses/delete/$data[id]"); ?>" data-prompt-msg=""="">
