        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Edit  Employees</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        <form role="form" enctype="multipart/form-data"  class="form form-horizontal needs-validation" novalidate action="<?php print_link("employees/edit/$page_id"); ?>" method="post">
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                ...
                                                <input name="photo" id="photo_input" required="" class="d-none" value="<?php  echo $data['photo']; ?>" type="text"  />
                                                    
                                                    
                                                </div>
                                                
                                                <?php Html :: uploaded_files_list($data['photo'], '#photo_input'); ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input  id="contact" value="<?php  echo $data['contact']; ?>" type="text" placeholder="Enter Contact"  required="" name="contact" class="form-control " />
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input  id="roles" value="<?php  echo $data['roles']; ?>" type="text" placeholder="Enter Roles"  required="" name="roles" class="form-control " />
