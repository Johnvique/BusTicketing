        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Edit  Reservations</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        <form role="form" enctype="multipart/form-data"  class="form form-horizontal needs-validation" novalidate action="<?php print_link("reservations/edit/$page_id"); ?>" method="post">
                            <div class="card-body">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  name="bus" placeholder="Select a value ..."    class="form-control">
                                                    <option selected><?php echo $data['bus']; ?></option>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input  id="level" value="<?php  echo $data['level']; ?>" type="text" placeholder="Enter Level"  required="" name="level" class="form-control " />
