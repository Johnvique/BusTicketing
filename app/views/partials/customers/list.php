        ...
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 comp-grid">
                    <h3 class="record-title">Customers</h3>
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('customers') ?>">Search</a>
                                    </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="card p-2 mb-4">
                                                ...
                                                <div>
                                                    <strong>Role</strong> :  <?php echo $data['role']; ?> 
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link('customers/view/'.$data['id']); ?>">
                                                    ...
                                                    <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link('customers/edit/'.$data['id']); ?>">
                                                    ...
                                                    <a class="btn btn-sm btn-danger recordDeletePromptAction has-tooltip" title="Delete this record" href="<?php print_link("customers/delete/$data[id]"); ?>" data-prompt-msg="">
                                ...
                                <div class="card-footer">
                                    <div class="row">   
                                        <div class="col-sm-2">  
                                            ...
                                            <?php Html :: import_form('customers/import_data' , "Import Data", 'CSV , JSON'); ?>
