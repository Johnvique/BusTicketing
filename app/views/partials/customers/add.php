        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Add New Customers</h3>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input  id="role" value="<?php  echo $this->set_field_value('role',''); ?>" type="text" placeholder="Enter Role"  required="" name="role" class="form-control " />
