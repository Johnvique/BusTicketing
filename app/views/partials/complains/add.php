        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Add New Complains</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        <form id="complains-add-form" role="form" enctype="multipart/form-data" class="form form-horizontal needs-validation"  novalidate action="<?php print_link("complains/add") ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input  id="booking_id" value="<?php  echo $this->set_field_value('booking_id',''); ?>" type="text" placeholder="Enter Booking Id" list="booking_id_list"  required="" name="booking_id" class="form-control " />
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input  id="driver" value="<?php  echo $this->set_field_value('driver',''); ?>" type="text" placeholder="Enter Driver's name" list="driver_list"  required="" name="driver" class="form-control " />
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input  id="bus_no" value="<?php  echo $this->set_field_value('bus_no',''); ?>" type="text" placeholder="Enter Bus No" list="bus_no_list"  required="" name="bus_no" class="form-control " />
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <textarea placeholder="Enter your Compliaint" required="" rows="" name="compliaint" class=" form-control"><?php  echo $this->set_field_value('compliaint',''); ?></textarea>
